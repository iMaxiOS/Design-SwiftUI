    ...
    var body: some View {
        ZStack {
            ...
            CardView(
                title: "Design in QA",
                descr: "Full course",
                bgColor: show ? Color(#colorLiteral(red: 0.5810584426, green: 0.1285524964, blue: 0.5745313764, alpha: 1)) : Color(#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1)),
                image: "3",
                showCard: $showCard
            )
            ...
            CardView(
                ...
                bgColor: show ? Color(#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1)) : Color(#colorLiteral(red: 0.5810584426, green: 0.1285524964, blue: 0.5745313764, alpha: 1)),
                image: "5",
                showCard: $showCard
            )
            .offset(x: viewState.width, y: viewState.height)
            ...
            CardView(
                ...
                descr: "Certificates",
                bgColor: Color(#colorLiteral(red: 0.1411764771, green: 0.3960784376, blue: 0.5647059083, alpha: 1)),
                image: "2",
                showCard: $showCard
            )
            .offset(x: viewState.width, y: viewState.height)
        ...
        .background(Color(.systemBackground).ignoresSafeArea(.all, edges: .all))
    }
}
